...
export function SideBarNav({ children }: Prop) {
  ...
  return (
    <div
      className={cn(
        "rounded-md flex flex-col md:flex-row bg-yellow-400 w-full flex-1 mx-auto border border-neutral-200 dark:border-neutral-700 overflow-hidden",
        "h-screen" // for your use case, use `h-screen` instead of `h-[60vh]`
      )}
    >
      <Sidebar open={open} setOpen={setOpen}>
        <SidebarBody className="justify-between bg-yellow-400  gap-10">
